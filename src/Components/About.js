  ...
  render() {
    return (
      <div className="container">
        <h1>Hi!</h1>
        <p className="lead">I hope you're enjoying ITGG</p>
        <p>
        ...
        <p>
          ...
          <a href="https://github.com/murribu/isthisguygood">the github page</a>{" "}
          for this project
        </p>
        <p>This system does not collect any user data.</p>
        <p>
          ...
          (my company) and tell us your software dreams.
        </p>
      </div>
    );
  }
